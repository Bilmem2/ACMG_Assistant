...
class ReportGenerator:
    ...
    def _write_insilico_analysis(self, f, variant_data, evidence_results: Dict[str, Any]):
        ...
        if vampp_score is not None:
            ...
            f.write("  a weighted approach inspired by the VAMPP-score framework.\n")
    ...
    def _write_references(self, f):
        ...
        f.write("1. Richards, S., et al. (2015). Standards and guidelines for the\n")
        f.write("   interpretation of sequence variants: a joint consensus recommendation\n")
        f.write("   of the American College of Medical Genetics and Genomics and the\n")
        f.write("   Association for Molecular Pathology. Genetics in Medicine, 17(5), 405-424.\n\n")
        
        f.write("2. Tavtigian, S. V., et al. (2020). ClinGen Sequence Variant Interpretation\n")
        f.write("   Working Group criteria for the evaluation of pathogenicity of constitutional\n")
        f.write("   sequence variants. Genetics in Medicine, 22(4), 703-713.\n\n")
        
        f.write("3. Aydin, E., et al. (2024). A New Era in Missense Variant Analysis:\n")
        f.write("   Statistical Insights and the Introduction of VAMPP-Score for Pathogenicity\n")
        f.write("   Assessment. bioRxiv, 2024.07.11.602867.\n\n")
        
        f.write("4. Ozdemir, O., et al. (2024). Molecular and In Silico Analysis of the\n")
        f.write("   CHEK2 Gene in Individuals with High Risk of Cancer Predisposition from\n")
        f.write("   Türkiye. Cancers, 16(22), 3876.\n\n")

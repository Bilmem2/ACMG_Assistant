...
def build_executable():
    ...
    cmd = [
        ...
        "--hidden-import", "scipy.stats", # Ensure scipy.stats is included
        "--hidden-import", "scipy.sparse", # Ensure scipy.sparse is included
        "--hidden-import", "scipy._cyutility", # Fix scipy dependency
